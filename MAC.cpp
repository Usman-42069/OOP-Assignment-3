...
MAC::MAC()
{
	...
	do {
		cout << "GraphicCard: \nEnter Type Of Graphic Card (APPLE GPU): ";
		getline(cin , specification);
	} while (specification != "APPLE GPU");
	...
	do {
		cout << "StorageDevice: \nEnter type of StorageDevice: (HDD / SSD / NAS HDD): ";
		cin >> specification;
	} while ((specification != "HDD") && (specification != "SSD") && (specification != "NAS HDD"));
